...
# ╔═╡ af032cf2-d702-4919-bf03-e55a2c8a5b3a
begin
	using DataFrames
	using CSV
end

# ╔═╡ d2ac296f-6f1e-40ca-b2d8-bf1a4fbc95e5
using Plots  # This will install plots

# ╔═╡ e6e5b567-a570-4d22-b256-e38018b4d450
using PlutoUI


# ╔═╡ 9180fc9d-efc8-4f94-9f94-c049d82673b1
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ c1b60c11-4a65-4ac5-9a78-82cd437b70e6
df.Country_code === df[!, "Country_code"]


# ╔═╡ fe9a73cb-6cdf-44df-8d6c-99149e9ae5cc
equals_sg(x::AbstractString) = x == "SG"


# ╔═╡ d0c140b9-135a-4c4d-bd74-43b3e3627026
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 87b996ad-5350-4211-8307-426df85082c0
dates = sg_data[!, "Date_reported"]


# ╔═╡ 46cbe880-62b5-46b9-84a3-be21f1eb25cb
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ 37217b47-233a-4550-a064-b7dba118025b
# ╠═╡ disabled = true
#=╠═╡
using Plots  # This will install plots
...
# ╔═╡ e4776b5d-167e-4171-881c-f5890d3ebf73
# ╠═╡ disabled = true
#=╠═╡
using Plots  # This will install plots
  ╠═╡ =#

# ╔═╡ 82c2bc00-a2b2-40fa-bd63-b404ea77f90a
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)


# ╔═╡ 1b0b7a80-3d6f-409d-a2fc-b407d9527ef4
...
# ╔═╡ 6c0182dd-62bc-489b-8e15-b54dfe1e52d5


# ╔═╡ 1be25e9f-713c-493d-9c4e-2547199e4752
@bind slider_value Slider(0:10:1000)

# ╔═╡ 90fd8033-77c4-4339-b2d7-c02ac0a1f096
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 6cda554c-e1f1-4cbf-8bc3-734778e20f04
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 0b0dc608-15f6-444a-b429-180e73bc0e77
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ ce19f9e3-4bcd-48b2-877c-7289af7a04a7
